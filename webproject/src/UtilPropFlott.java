...
public class UtilPropFlott {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\admin\\Desktop\\Classes\\Introduction to Software Engineering\\workspace4830\\workspace4830-techexercise-flott\\webproject\\WebContent\\config.properties";
